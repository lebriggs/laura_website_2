...
```{r Return Chunk, echo=TRUE, eval=FALSE}
...
```{r Subsequent Session Chunk, echo=TRUE, eval=FALSE}
...
```{r Summary Chunk, echo=TRUE, eval=FALSE}
...
```{r fakepkg Chunk, echo=TRUE, eval=FALSE}
